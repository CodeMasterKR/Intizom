      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2.5 mb-10">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#0a9090' }}>
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
              </svg>
            </div>
            <span className="text-base font-semibold" style={{ color: 'var(--text-1)' }}>Intizom</span>
          </div>

          {/* Heading */}
          <div className="mb-7">
            <h1 className="text-2xl font-semibold mb-1.5" style={{ color: 'var(--text-1)' }}>
              Kirish
            </h1>
          ...
          <button
            type="button"
            onClick={() => !USE_MOCK && handleGoogleLogin()}
          ...
          {USE_MOCK && (
            <p className="text-xs text-center mt-4" style={{ color: 'var(--text-2)' }}>
              Demo rejim — istalgan ma'lumot bilan kirish mumkin
            </p>
          )}
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl font-bold leading-snug mb-4" style={{ color: 'rgba(255,255,255,0.97)' }}>
            Har kuni<br />rivojlaning
          </h2>
          <p className="text-sm leading-relaxed mb-10" style={{ color: 'rgba(255,255,255,0.65)' }}>
            Odatlaringizni kuzating, maqsadlaringizga tering va natijalarni ko'ring.
          </p>
