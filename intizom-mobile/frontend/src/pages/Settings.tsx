...
import { User, Lock, Palette, Bell, LogOut, Sun, Moon, Monitor, Save, Camera } from 'lucide-react';
...
const themes: { value: Theme; label: string; icon: typeof Sun; desc: string }[] = [
  ...
  { value: 'system', label: 'Tizim', icon: Monitor, desc: 'Qurilma sozlamalariga qarab' },
];
